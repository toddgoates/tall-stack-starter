<main class="h-[calc(100vh-64px)] bg-gray-300 text-gray-800 flex justify-center items-center">
    <div class="bg-gray-100 rounded p-6 shadow-lg m-6 w-full md:w-1/2 lg:w-1/3">
        ...
        @endif
        <form class="space-y-8 mb-12" wire:submit="login" x-data="{ showPassword: false }">
            <div>
            ...
            <div>
                ...
                <div class="mt-2 flex rounded-md shadow-sm">
                    ...
                    <button type="button" x-on:click="showPassword = !showPassword" class="relative -ml-px inline-flex items-center gap-x-1.5 rounded-r px-3 py-2 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-gray-700 hover:bg-gray-50" aria-label="Toggle password">
